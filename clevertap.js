  ...
  const _tr = (msg, _ref) => {
    ...
    const renderFooterNotification = targetingMsgJson => {
      ...
      if (displayObj.preview && displayObj['custom-editor']) {
        iframe.sandbox = 'allow-scripts allow-popups allow-popups-to-escape-sandbox'; // /* eslint-disable no-cond-assign */
        // var regex = /([\w-]*)\s*:\s*([^;]*)/g
        // var match; var properties = {}
        // while (match = regex.exec(html)) properties[match[1]] = match[2].trim()
        // console.log('props', properties, html)
        ...
        console.log('propsss', html, properties);
        /* eslint-enable no-cond-assign */
      }
