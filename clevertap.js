  ...
  var Inbox = /*#__PURE__*/function (_HTMLElement) {
    ...
    _createClass(Inbox, [{
      ...
      value: function getInboxStyles() {
        var headerHeight = 36;
        var categoriesHeight = this.config.categories.length ? 64 : 0;
      ...
      if (displayObj.wtarget_type === 2) {
        ...
        if (targetingMsgJson.msgContent.type === 2) {
          ...
          if (document.getElementById(_divId) == null) {
            ...
            var backoffCounter = 0; // Callback function to execute when mutations are observed

            var callback = function callback(mutationList, observer) {
              if (document.getElementById(_divId) != null && backoffCounter <= 2) {
                backoffCounter = 3;
