(function (global, factory) {
  ...
  var renderVisualBuilder = function renderVisualBuilder(targetingMsgJson, isPreview) {
    ...
    var processElement = function processElement(element, selector) {
      var _selector$values$isTr, _selector$values;
      ...
      if ((_selector$values$isTr = selector.values.isTrackingClicks) === null || _selector$values$isTr === void 0 ? void 0 : _selector$values$isTr.name) {
